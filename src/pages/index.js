...
const Home = () => {
  ...
  return (
    ...
    >
      <div style={{ justifyContent: "center", marginBottom: "15px", display: "flex" }}>
        <h3 style={{ margin: "10px 0px" }}>7 types of native errors in javaScript based on this{" "}</h3>
        <Link style={{ margin: "auto 0px auto 5px" }} href="https://blog.bitsrc.io/types-of-native-errors-in-javascript-you-must-know-b8238d40e492">
          link
        </Link>
      </div>
      <div>
